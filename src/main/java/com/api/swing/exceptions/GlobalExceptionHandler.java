...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleAll(DuplicateKeyException dupErr, WebRequest request) {

		List<String> details = new ArrayList<String>();
		details.add(dupErr.getLocalizedMessage());

		ApiError err = new ApiError(LocalDateTime.now(), HttpStatus.CONFLICT, "Unique value for USERNAME and EMAIL", details);
